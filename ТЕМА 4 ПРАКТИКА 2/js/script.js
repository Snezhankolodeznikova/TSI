...
if ((getNickName("@oziaba") === "@oziaba") && (getNickName("python.hub") === "@python.hub")) {
    ...
    document.getElementById("zadanie1").innerHTML = "1. Правильно"
} else {
    console.log("Плохо")
    document.getElementById("zadanie1").innerHTML = "1. Неправильно"
}
...
if ((getCurrency("$100") === "Доллар" && getCurrency("5€") === "Евро" && getCurrency("30 USD") === "Недоступно" )) {
    console.log("Правильно")
    document.getElementById("zadanie2").innerHTML = "2. Правильно"
} else {
    console.log("Плохо")
    document.getElementById("zadanie1").innerHTML = "2. Неправильно"
}
...
if (getSlug("Red Bull Gives You Wings") === "red-bull gives " &&
    ...
    console.log("Правильно")
    document.getElementById("zadanie3").innerHTML = "3. Правильно"
} else {
    console.log("Плохо")
    document.getElementById("zadanie1").innerHTML = "3. Неправильно"
}
...
if (getTodosNumber("Купить хлеб,Купить сыр,Приготовить ужин") === 3 &&
    ...
    console.log("Правильно")
    document.getElementById("zadanie4").innerHTML = "4. Правильно"
} else {
    console.log("Плохо")
    document.getElementById("zadanie1").innerHTML = "4. Неправильно"
}
...
if (renderTableRows(data) === "<tr><td>Bitcoin</td><td>40468</td><td>Ethereum</td><td>3005</td><td>Solana</td><td>106</td><td>Tether</td><td>1</td></tr>") {
    console.log("Правильно")
    document.getElementById("zadanie5").innerHTML = "5. Правильно"
} else {
    console.log("Плохо")
    document.getElementById("zadanie1").innerHTML = "5. Неправильно"
}
...
if (notAnExcellent([4, 2, 3, 5]) === true &&
    ...
    console.log("Правильно")
    document.getElementById("zadanie6").innerHTML = "6. Правильно"
} else {
    console.log("Плохо")
    document.getElementById("zadanie1").innerHTML = "6. Неправильно"
}
...
if (diff(demoteUser(user), ["Moderator", "Editor"]) &&
    ...
    console.log("Правильно")
    document.getElementById("zadanie7").innerHTML = "7. Правильно"
} else {
    console.log("Плохо")
    document.getElementById("zadanie1").innerHTML = "7. Неправильно"
}
...
if (multiply([123, 78]) === 9594 &&
    ...
    console.log("Правильно")
    document.getElementById("zadanie8").innerHTML = "8. Правильно"
} else {
    console.log("Плохо")
    document.getElementById("zadanie1").innerHTML = "8. Неправильно"
}
...
if (getUserInfo(["Nina", 25]) === "Пользователю Nina - 25 лет." &&
    ...
    console.log("Правильно")
    document.getElementById("zadanie9").innerHTML = "9. Правильно"
} else {
    console.log("Плохо")
    document.getElementById("zadanie1").innerHTML = "9. Неправильно"
}
...
diff(joinArrays(['When', 'There'], ['Is', 'No', 'Tomorrow']), ['When', 'There', 'Is', 'No', 'Tomorrow'])){
    console.log("Правильно")
    document.getElementById("zadanie10").innerHTML = "10. Правильно"
} else {
    console.log("Плохо")
    document.getElementById("zadanie1").innerHTML = "10. Неправильно"
}
